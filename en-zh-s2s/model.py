...
'''
TODO:
    When the parameters can be trained, such as embedding layer
'''
...
class Decoder(nn.Module):
    ...
    def forward(self, input, last_hidden, encoder_outputs):
        ...
        output = output.squeeze(0)  # (1,B,N) -> (B,N), same with the hidden
...
class Seq2Seq(nn.Module):
    ...
    def forward(self, src, trg, teacher_forcing_ratio=0.5):
        ...
        hidden = hidden[:self.decoder.n_layers]   # [1,B,H]
        output = trg.data[0, :]  # sos, [B]
        for t in range(1, max_len):
            ...
            for_output = trg.data[t] if is_teacher else top1
